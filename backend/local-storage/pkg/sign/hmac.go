...
// with the expire timestamp by ":". The expire timestamp travels
// in plaintext so Verify can read it without knowing the secret.
...
// expire and the expire timestamp is still in the future. expire == 0
// is "never expires".
...
// secret should be at least 32 bytes; shorter secrets weaken the
// HMAC.
