	...
	return types.Services{
		{
			...
			Extensions: map[string]interface{}{
				common.ComposeExtensionNameXPowerLab: c.AppStoreInfo(),
			},
		},
	}
}
...
func (c *CustomizationPostData) Compose() codegen.ComposeApp {
	return codegen.ComposeApp{
		Name:     strings.ToLower(c.ContainerName),
		Services: c.Services(),
		// New compose docs author x-powerlab as the canonical extension key.
		// Reads still understand legacy x-web / x-casaos via the translation
		// layer in service/extension.go.
		Extensions: map[string]interface{}{
			common.ComposeExtensionNameXPowerLab: c.ComposeAppStoreInfo(),
		},
	}
}
